...
const Hero = () => {
  return (
    <>
      <Fullscreen className="font-Figtree p-5 flex items-center justify-center space-x-10">
        <div className="space-y-10">
          ...
          <div>
            ...
            <h1 className="text-6xl font-bold">I'm a full-stack dev :3</h1>
          </div>
        ...
        <Separator
          ...
          className="min-h-60 min-w-1 flex bg-fontDefault"
        />
